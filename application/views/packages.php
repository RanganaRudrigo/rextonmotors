                ...
                <div class="products-category">
                    ...
                    <div class="products-list row list">
                                        ...
                                        foreach ($media->Packages as $val): ?>
                                            <div class="feature-box well"> <i class="feature-icon fa fa-book"></i>
                                                <div class="feature-content">
                                                    ...
                                                    <a href="<?= base_url('Package-Details/').url_title($media->MediaComTitle).'/'.url_title($val->PackagesTitle).'/'.$val->PackagesId ?>">Read More <i class="fa fa-angle-right"></i></a>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                            </div>
                        ...
                        <div class="product-layout col-md-4 col-sm-4 col-xs-12 ">
                            <div>
                                <a href="#"><img src="http://microworld.dev/media/images/vidcon.jpg" alt="banner1"></a>
                            </div>
