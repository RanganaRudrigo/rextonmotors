            ...
            <div class="container pt-70 pb-40">
                <div class="section-content">
                    <div class="row">
                        ...
                        <?php foreach ($latast_news as $news): ?>
                            <div class="col-sm-6 col-md-4">
                                <article class="post clearfix mb-30 bg-lighter">
                                    <div class="entry-header">
                                        <div class="post-thumb thumb">
                                            <img src="<?= UP.$news->Image ?>" alt="" class="img-responsive img-fullwidth">
                                        </div>
                                            ...
                                            <div class="media-body pl-0">
                                                <div class="event-content pull-left flip">
                                                    <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5">
                                                        <a href="<?= base_url().'News-Event/'.url_title($news->NewsTitle).'/'.$news->NewsId?>">
                                                            <?= $news->NewsTitle ?>
                                                        </a>
                                                    </h4>
