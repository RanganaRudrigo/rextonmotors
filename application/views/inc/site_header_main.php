            ...
            <div class="col-xs-12 col-sm-3 col-md-2">
                <div class="widget no-border m-0">
                    <div class="mt-10 mb-10 text-right flip sm-text-center">
                        ...
                        <a href="#" class="font-12 text-gray"> info@rextonmorters.lk</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive">
                <ul class="menuzord-menu">
                    ...
                    <li id="brand"><a href="<?= base_url('Home') ?>">Brands</a>

                    </li>
                    <li id="news"><a href="<?= base_url('News-Events') ?>">News &amp Events</a>

                    </li>
                    <li id="contact"><a href="<?= base_url('Contact-Us') ?>">Contacts</a>
                ...
                <ul class="pull-right flip hidden-sm hidden-xs">
                    <li>
                        ...
                        <a class="btn btn-colored btn-flat bg-theme-color-2 text-white font-14 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" data-toggle="modal" data-target="#BSParentModal" href="ajax-load/reservation-form.html">Call Back Request</a>
                        <!-- Modal: Book Now End -->
                    </li>
                </ul>
