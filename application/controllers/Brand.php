...
//        p($CategoryId);exit;
        $d['all_category'] = $this->category->get_all();
        $d['all_brand'] = $this->brand->get_all();
...
//        ============================================================================
        $config["base_url"] = base_url() . "Products-Brand/".url_title($this->uri->segment(2)).'/'.$d['one_brand']->BrandId;
