                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Service <?= empty($obj->ServiceId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="EventTitle" name="form[ServiceTitle]"
                                                               value="<?= $obj->ServiceTitle ?>"
                                                               class="form-control">
                                                        <?= form_error('form[ServiceTitle]') ?>
                                                    </div>
                                                </div>
                                            </div>
