        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Service Re-arrange</h4>
                        <ol class="breadcrumb p-0">
                            <li><a href="<?= base_url('admin') ?>">Dashboard</a></li>
                            <li><a href="<?= base_url('admin/service') ?>"> Service</a></li>
                            <li class="active"> Service Re-arrange</li>
                        </ol>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">Service Re-arrange</h4>

                        <p id="status"></p>

                        <input type="hidden" id="view" value="service"/>
                        <input type="hidden" id="id" value="ServiceId"/>
